# Mail 1b — Altbau Thermal → co2online gGmbH

**Status:** Entwurf als Datei, **kein Gmail-Draft** (Gmail-MCP blockiert: Google-Cloud-Projekt nicht im Workspace Developer Preview). Nicht gesendet. Nachrangiger Empfänger der Dose — Mail 1 (UdK-Projektkoordination) geht zuerst.
**An:** **Adresse offen.** Von der Kontakt-/Presseseite von co2online kopieren, nicht raten. Am 19.9.2026 konnte ich die Seite nicht abrufen (WebFetch gesperrt) — also nichts eingetragen.
**Betreff:** Idee zu verschenken: die Wohnungsebene zu EnergyMap Berlin
**Vor dem Senden:**
