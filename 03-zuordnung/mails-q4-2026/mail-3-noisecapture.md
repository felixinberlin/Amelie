# Mail 3 — Kiez-Lärmkarte (method) → Noise-Planet / NoiseCapture

**Status:** Entwurf als Datei, **kein Gmail-Draft** (Gmail-MCP noch nicht freigeschaltet). Nicht gesendet.
**An:** contact@noise-planet.org — auf `noise-planet.org/NoiseCapture_privacy_policy.html` als Kontakt genannt (19.9.2026 abgelesen). Ein Suchergebnis nannte zusätzlich noisecapture@noise-planet.org; das habe ich auf der Seite selbst nicht bestätigt gefunden, deshalb die erste Adresse.
**Subject:** Free idea: quiet windows instead of average levels
**Vor dem Senden:** Englisch, wie im Plan. Link zeigt auf die englische Dose (`en/05-dosen/`).
...
https://github.com/felixinberlin/Amelie/blob/main/en/05-dosen/kiez-laermkarte.md

CC0, no strings, no follow-up. If this is already in your roadmap, please just ignore this.

Félix, Berlin
github.com/felixinberlin/Amelie
