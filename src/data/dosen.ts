...
export const DOSEN_DATA: DoseItem[] = [
  ...
  },
  {
    ...
    failureModeDe: 'Falsche Fristerkennung oder Rechtsberatungs-Verstoß (RDG): Eine halluzinierte Frist kann Bürgern existenzielle Säumniszuschläge einbringen. Gegenmaßnahme: Deterministischer OCR-Datumsfilter parallel zum LLM, Quelltext-Verlinkung zu jedem Satz und strikter Fokus auf reine Verständnishilfe nach DIN SPEC 33429.',
    failureModeEn: 'Hallucinated deadlines or unauthorized legal advice (RDG violation): A missed date causes punitive surcharges. Countermeasure: Dual deterministic regex extraction alongside LLM, synchronized source highlights, and strict framing as DIN SPEC 33429 cognitive reading aid.',
    priorArtDe: 'Kommerzielle KI-Chats (ChatGPT, DeepL Write) verlangen US-Cloud-Uploads; Behörden-Websites in Leichter Sprache erklären nur allgemeine Gesetze, nicht den konkreten Brief; analoge Beratungsstellen haben monatelange Wartezeiten.',
    priorArtEn: 'Cloud AI services (ChatGPT, DeepL) demand sensitive personal uploads; official plain-language portals describe abstract laws rather than the individual letter; legal aid clinics suffer multi-month backlogs.',
    emailTemplate: {
  ...
  },
  {
    ...
    failureModeDe: 'Degeneration zur austauschbaren Bestimmungs-App: Wenn die narrative Überhöhung („Rebel Botanists", Toughness Index, Zeitraffer) fehlt, nutzen Anwender etablierte Tools. Gegenmaßnahme: Kompromisslose Fokussierung auf Pflaster- und Asphaltritzen und enge Partnerschaft mit Senckenberg.',
    failureModeEn: 'Becoming just another generic plant identifier: Without strong storytelling (Rebel Botanists, Toughness Index, time-lapse), users default to Google Lens or Flora Incognita. Countermeasure: Strict thematic boundary on pavement survivors and deep institutional partnership with #Krautschau.',
    priorArtDe: 'PlantNet und Flora Incognita bieten erstklassige Bestimmung, sind aber neutrale wissenschaftliche Werkzeuge ohne Urban-Survival-Gamification. #Krautschau ist eine fantastische Kreide-Kampagne, aber keine ganzjährige Software.',
    priorArtEn: 'PlantNet and Flora Incognita provide great identification but remain neutral academic tools without urban narrative. #Krautschau is a vibrant chalk movement, but not a year-round interactive app.',
    emailTemplate: {
