...
export const DOSEN_DATA: DoseItem[] = [
  ...
  },
  {
    ...
    firstStepDe: {
      ticket: 'Erledigt am 22.09.2026: das Schema ausführbar machen, ohne eine Zeile Bilderkennung. Liegt in 04-werkzeug/glasanflug-ampel/.',
      criteria: 'Regeldatei mit den Wortlauten des Beschlusses, reine Bewertungsfunktion mit Herkunftsangabe je Eingabewert, 26 Tests grün — darunter alle elf durchgerechneten Beispiele aus dem Anhang des Beschlusses und die Münchner Felddaten. Nächstes Ticket: Kriterium 1 (Anteil frei sichtbarer Glasfläche ohne Markierung) aus einem gemeldeten Fassadenfoto schätzen. Fertig, wenn für dreißig handbestimmte Fassaden die geschätzte Stufe in vier von fünf Fällen stimmt und jede Abweichung mit dem Bild daneben erklärbar ist.'
    },
    firstStepEn: {
      ticket: 'Done on 22 Sep 2026: make the scheme executable without a single line of computer vision. Lives in 04-werkzeug/glasanflug-ampel/.',
      criteria: 'Rule file carrying the decision\'s wording, a pure scoring function with an origin tag per input, 26 tests green — including all eleven worked examples from the decision\'s annex and the Munich field data. Next ticket: estimate criterion 1 (share of freely visible unmarked glass) from a reported façade photo. Done when the estimated band is right for four out of five of thirty hand-measured façades and every deviation is explainable from the image.'
    },
