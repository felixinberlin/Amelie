...
export const NORMAL_JOBS_AND_EVERYDAY_PEOPLE_IDEAS: CandidateIdea[] = [
  {
    ...
    evidenceDe: 'Über 1,2 Millionen Pflegekräfte in Deutschland arbeiten im Schichtdienst. Durch hektische Dienstplanänderungen entgehen Pflegenden laut Berufsverbänden bis zu 300 € monatlich an unberechneten Zuschlägen. Illegale Schichtfolgen (Spät auf Früh) treiben Tausende in den Burnout.',
    evidenceEn: 'Over 1.2 million hospital nurses and caregivers rotate through grueling shifts. Due to messy paper roster updates, nurses lose hundreds of dollars monthly in missing night and weekend overtime premiums, while back-to-back turnaround shifts fuel severe burnout.',
    reviewDate: '10/2026',
...
Zero paywalls, zero subscriptions. Free for all unions and healthcare workers worldwide.`
  ...
  },
  {
    ...
    evidenceDe: 'Handwerksbetriebe haften jährlich für Millionen an Gewährleistungsschäden, weil sie Bedenken gegen mangelhafte Vorleistungen (z.B. zu feuchter Estrich) nicht rechtzeitig schriftlich nach VOB angemeldet haben. Auf staubigen Baustellen hat niemand einen Laptop dabei.',
    evidenceEn: 'Independent subcontractors lose tens of thousands of dollars in unfair defect lawsuits because they failed to file formal written warning letters before starting work over flawed substrate installed by general contractors.',
    reviewDate: '10/2026',
...
We present to you a completely free public domain tool (CC0): "BedenkenBlitz". It empowers solo tilers, painters, and drywallers to generate legally binding substrate defect warning letters in 15 seconds from a spoken voice note on dusty jobsites, saving them from catastrophic warranty lawsuits.`
  ...
  },
  {
    ...
    evidenceDe: 'Über 700.000 Reinigungskräfte arbeiten in Deutschland, viele mit Migrationshintergrund. Versehentliches Mischen von Sanitär-Entkalkern (Säure) mit chlorhaltigen Bleichmitteln (Hypochlorit) führt jährlich zu Hunderten von schweren Lungenverätzungen.',
    evidenceEn: 'Commercial cleaning employs over 3 million workers across North America and Europe, many with limited host-country language fluency. Inadvertent mixing of acid cleaners and bleach triggers hundreds of severe toxic inhalation poisonings yearly.',
    reviewDate: '10/2026',
